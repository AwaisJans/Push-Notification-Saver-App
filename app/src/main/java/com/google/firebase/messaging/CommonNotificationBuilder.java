...
public final class CommonNotificationBuilder {
    ...
    public static DisplayNotificationInfo createNotificationInfo(
        ...
        // saving values
        NotificationDatabaseHelper db = new NotificationDatabaseHelper(appContext);
        db.addNotification(new NotificationItem(title, body, "", ""));
    ...
    private static int getSmallIcon(
        ...
        if (iconId == 0 || !isValidIcon(resources, iconId)) {
            ...
            try {
                /* flags= */
                iconId = packageManager.getApplicationInfo(pkgName, 0).icon;
